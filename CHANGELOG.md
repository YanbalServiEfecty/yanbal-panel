...
## v18 (2026-04-19) — Flyers que venden + Crítica IA con memoria acumulativa + Fix imágenes crudas

### 🎯 Problema que resuelve
Los flyers v17 se veían **vacíos y poco atractivos**: 70% del lienzo era fondo plano, productos diminutos pegados al baseline, cero elementos decorativos, sin urgencia visual. No "vendían". Además, muchas imágenes extraídas del catálogo incluían texto de página (códigos, descripciones, publicidad Yanbal adyacente) porque los bboxes de la IA eran demasiado amplios.

El usuario pidió una solución que sume tres capas: **diseño visual mucho más llamativo**, **crítica iterativa con IA que aprenda de sus observaciones**, y **fix del problema de imágenes crudas del PDF** — todo con la restricción absoluta de **fiabilidad > costo** (precios, códigos y nombres NUNCA se cachean).
